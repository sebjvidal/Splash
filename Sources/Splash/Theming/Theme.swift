...
public struct Theme {
    ...
    public var plainTextColor: DynamicColour
    /// What color to use for the background
    public var backgroundColor: DynamicColour
    /// What color to use for the text's highlighted tokens
    public var tokenColors: [TokenType: DynamicColour]

    public init(font: Font,
                plainTextColor: DynamicColour,
                tokenColors: [TokenType: DynamicColour],
                backgroundColor: DynamicColour = DynamicColour(light: Color(white: 0.12, alpha: 1))) {
        self.font = font
