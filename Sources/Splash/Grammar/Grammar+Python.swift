...
private extension PythonGrammar {
    ...
    static let builtInTypes: Set<String> = [
        ...
        "str", "unicode", "basestring", "list", "tuple",
        "xrange", "dict", "set", "frozenset", "type",
        "object", "file"
    ]
    ...
    struct CommentRule: SyntaxRule {
        ...
        func matches(_ segment: Segment) -> Bool {
            ...
            return segment.tokens.onSameLine.contains(anyOf: "#")
        }
    }
    ...
    struct KeywordRule: SyntaxRule {
        ...
        func matches(_ segment: Segment) -> Bool {
            if segment.tokens.current == "prefix" && segment.tokens.next == "def" {
                return true
            }
...
//            }
            ...
            if let previousToken = segment.tokens.previous {
                ...
                if !declarationKeywords.contains(segment.tokens.current) {
                    ...
                    guard !segment.tokens.previous.isAny(of: "def", "`") else {
                        return false
                    }
                }
            }
...
//            }
    ...
    struct OtherTypeRule: SyntaxRule {
        ...
        func matches(_ segment: Segment) -> Bool {
            if keywords.contains(segment.tokens.current) {
                return false
            }
    ...
    struct OtherDeclarationRule: SyntaxRule {
        ...
        func matches(_ segment: Segment) -> Bool {
            ...
            guard segment.tokens.previous.isAny(of: "def", "var", "let", "const", "case", "for") else {
                return false
            }
    ...
    struct ParameterRule: SyntaxRule {
        ...
        func matches(_ segment: Segment) -> Bool {
            ...
            guard !segment.tokens.onSameLine.contains("if") else {
                return false
            }
